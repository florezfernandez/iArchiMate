 ...
 * @generated
 */
public class IArchimateElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public IArchimateElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						iArchimate.diagram.part.Messages.IArchimateElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "iarchimate".equals(fileExtension); //$NON-NLS-1$
	}
