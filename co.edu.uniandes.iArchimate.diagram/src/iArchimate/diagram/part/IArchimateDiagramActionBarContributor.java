...
public class IArchimateDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return iArchimate.diagram.part.IArchimateDiagramEditor.class;
	}
	...
	protected String getEditorId() {
		return iArchimate.diagram.part.IArchimateDiagramEditor.ID;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new iArchimate.diagram.part.ValidateAction(
				page);
