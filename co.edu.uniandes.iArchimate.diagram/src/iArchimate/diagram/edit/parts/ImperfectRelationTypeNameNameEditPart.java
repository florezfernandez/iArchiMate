 ...
 * @generated
 */
public class ImperfectRelationTypeNameNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				iArchimate.diagram.part.IArchimateVisualIDRegistry
						.getType(iArchimate.diagram.edit.parts.ImperfectRelationTypeNameNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ImperfectRelationTypeNameNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new iArchimate.diagram.edit.policies.IArchimateTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = iArchimate.diagram.providers.IArchimateParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					iArchimate.diagram.edit.parts.IArchimateEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new ImperfectRelationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ImperfectRelationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImperfectRelationLabelFigure() {
			this.setText("ImperfectRelation");
		}
