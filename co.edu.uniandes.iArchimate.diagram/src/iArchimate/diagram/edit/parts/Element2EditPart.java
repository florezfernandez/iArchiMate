 ...
 * @generated
 */
public class Element2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Element2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new iArchimate.diagram.edit.policies.Element2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof iArchimate.diagram.edit.parts.ElementName2EditPart) {
			((iArchimate.diagram.edit.parts.ElementName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureElementLabelFigure());
			return true;
		}
		if (childEditPart instanceof iArchimate.diagram.edit.parts.ElementElementComponentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getElementComponentsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((iArchimate.diagram.edit.parts.ElementElementComponentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof iArchimate.diagram.edit.parts.ElementElementComponentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getElementComponentsCompartmentFigure();
			pane.remove(((iArchimate.diagram.edit.parts.ElementElementComponentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
