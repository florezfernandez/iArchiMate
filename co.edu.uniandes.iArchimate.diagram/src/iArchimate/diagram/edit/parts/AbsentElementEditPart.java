 ...
 * @generated
 */
public class AbsentElementEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AbsentElementEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new iArchimate.diagram.edit.policies.AbsentElementItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof iArchimate.diagram.edit.parts.AbsentElementNameEditPart) {
			((iArchimate.diagram.edit.parts.AbsentElementNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureAbsentElementLabelFigure());
			return true;
		}
		if (childEditPart instanceof iArchimate.diagram.edit.parts.AbsentElementAbsentElementComponentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getAbsentElementComponentsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((iArchimate.diagram.edit.parts.AbsentElementAbsentElementComponentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof iArchimate.diagram.edit.parts.AbsentElementAbsentElementComponentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getAbsentElementComponentsCompartmentFigure();
			pane.remove(((iArchimate.diagram.edit.parts.AbsentElementAbsentElementComponentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
