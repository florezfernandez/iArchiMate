...
public class RelationReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof iArchimate.Relation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return iArchimate.diagram.edit.policies.IArchimateBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRelation_4013(container,
	 ...
	 * @generated
	 */
	protected iArchimate.Relation getLink() {
		return (iArchimate.Relation) getElementToEdit();
	}
