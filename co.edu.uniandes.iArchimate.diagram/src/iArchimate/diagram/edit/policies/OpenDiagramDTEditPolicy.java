 ...
 * @generated
 */
public class OpenDiagramDTEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends
		...
		OpenDiagramCommand(HintedDiagramLinkStyle linkStyle) {
			...
			super(TransactionUtil.getEditingDomain(linkStyle),
					iArchimate.diagram.part.Messages.CommandName_OpenDiagram,
					null);
		...
		protected String getEditorID() {
			return "iArchimate.diagram.dt.part.IArchimateDiagramEditorID";
		}
	}
