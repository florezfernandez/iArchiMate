 ...
 * @generated
 */
public class DecisionTraceItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (iArchimate.diagram.part.IArchimateVisualIDRegistry
					.getVisualID(incomingLink) == iArchimate.diagram.edit.parts.ElementElementDecisionTraceEditPart.VISUAL_ID) {
