...
import co.edu.uniandes.iArchimate.indicators.imperfection.ImperfectComponentsByRelation;
import co.edu.uniandes.iArchimate.ui.view.IndicatorViewLauncher;

public class NumberOfImperfectComponentsByRelationHandler extends AbstractHandler {

	public Object execute(ExecutionEvent event) throws ExecutionException {
		Indicator indicator = new ImperfectComponentsByRelation();
