...
public class IArchimateDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof iArchimate.diagram.dt.navigator.IArchimateDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((iArchimate.diagram.dt.navigator.IArchimateDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new iArchimate.diagram.dt.navigator.IArchimateDomainNavigatorItem(
