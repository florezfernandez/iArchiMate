...
public class DocumentEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new iArchimate.diagram.dt.edit.policies.DocumentItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof iArchimate.diagram.dt.edit.parts.DocumentNameEditPart) {
			((iArchimate.diagram.dt.edit.parts.DocumentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureDocumentLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class DocumentFigure extends SVGFigure {
		...
		public DocumentFigure() {
			this.setURI("platform:/plugin/co.edu.uniandes.iArchimate/icons/document.svg");
