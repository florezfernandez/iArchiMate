...
public class DecisionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new iArchimate.diagram.dt.edit.policies.DecisionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof iArchimate.diagram.dt.edit.parts.DecisionIdDecisionEditPart) {
			((iArchimate.diagram.dt.edit.parts.DecisionIdDecisionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureDecisionLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == iArchimate.diagram.dt.providers.IArchimateElementTypes.DecisionDecisionFacts_4003) {
	 ...
	 * @generated
	 */
	public class DecisionFigure extends SVGFigure {
		...
		public DecisionFigure() {
			this.setURI("platform:/plugin/co.edu.uniandes.iArchimate/icons/decision.svg");
