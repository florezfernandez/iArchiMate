 ...
 * @generated
 */
public class AttributeFactIdFactEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AttributeFactIdFactEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new iArchimate.diagram.dt.edit.policies.IArchimateTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = iArchimate.diagram.dt.providers.IArchimateParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					iArchimate.diagram.dt.edit.parts.IArchimateEditPartFactory
