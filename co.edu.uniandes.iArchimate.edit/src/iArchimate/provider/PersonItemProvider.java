...
/**
 * This is the item provider adapter for a {@link iArchimate.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
    if (itemPropertyDescriptors == null)
    {
      ...
      addOrganizationalUnitPropertyDescriptor(object);
  ...
  /**
   * This adds a property descriptor for the Organizational Unit feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addOrganizationalUnitPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Person_organizationalUnit_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Person_organizationalUnit_feature", "_UI_Person_type"),
         IArchimatePackage.Literals.PERSON__ORGANIZATIONAL_UNIT,
         true,
         false,
         false,
  ...
  protected void addRolPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Person_rol_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Person_rol_feature", "_UI_Person_type"),
         IArchimatePackage.Literals.PERSON__ROL,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
